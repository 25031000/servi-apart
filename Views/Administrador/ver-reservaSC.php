                    ...
                    <div class="col-lg-8 p-r-0 title-margin-right">
                        <div class="page-header">
                            <div class="page-title d-flex align-items-center">
                                <div class="icon-content p-2 rounded-circle" style="background-color: #18d26e; padding:25px; ">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="box-head">
                                    <div class="p-2  d-flex justify-content-end">
                                        ...
                                        <button id="GenerarPDF" class="btn p-2 btn-danger mx-2 "><a class="text-light" href="../../services/generatepdfSalonComunal.php" target="_blank">Generar PDF</a></button>
